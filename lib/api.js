...
function startRpcMonitoring(rpc, module, method, interval) {
	if (module === "daemon") {
		method = networkDataRpcMode ? networkDataRpcMode : 'getinfo';
	}
    setInterval(function() {
        rpc(method, {}, function(error, response) {
			...
			if (module === "daemon" && response && response.pow_difficulty && response.height) {
				redisCommands.push(['hset', key, "difficulty", response.pow_difficulty]);
				redisCommands.push(['hset', key, "height", response.height]);
			}
